...
public class Constants {
    ...
    // model ids
    public static final String ModelChatGLM6BSSE = "chatGLM_6b_SSE";
    public static final String ModelChatGLM6B = "chatglm_6b";
    ...
    // invoke methods
    public static final String invokeMethodSync = "invoke";

...
/**
 * Deserializer that can build instances of {@link ChatFunctionCall} from any
 * JSON content, using appropriate {@link ChatFunctionCall} type.
 */
public class ChatFunctionCallDeserializer extends BaseNodeDeserializer<ChatFunctionCall> {
    ...
    /**
     * Singleton instance of generic deserializer for {@link ChatFunctionCallDeserializer}.

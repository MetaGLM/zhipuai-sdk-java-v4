...
/**
 * Deserializer that can build instances of {@link Choice} from any
 * JSON content, using appropriate {@link Choice} type.
 */
public class ChoiceDeserializer extends BaseNodeDeserializer<Choice> {
    ...
    /**
     * Singleton instance of generic deserializer for {@link ChoiceDeserializer}.
